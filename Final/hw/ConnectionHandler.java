					...
					while (!waiting)
					{
						...
						} else
						{
							...
							if (tokens[0].equals("RESULT:"))
							{
								...
								{
									mV = new BigInteger(tokens[2], 32);
									mN = new BigInteger(tokens[3], 32);
								} else if (tokens[1].equals("AUTHORIZE_SET"))
								{
									...
									for (int count = 0; count < lengthOfAuthorizeSet; count++)
									{
										...
										BigInteger value = new BigInteger(tokens[count + 2], 32);
								...
								} else if (tokens[1].equals("SUBSET_K"))
								{
									...
									for (int count = 0; count < lengthOfSubsetK;)
									{
										...
										BigInteger value = new BigInteger(tokens[count + 2], 32); // Integer.parseInt(tokens
																								// [count
																								// +2]);
